...
# Path to Tesseract OCR executable (change this if needed)
# pytesseract.pytesseract.tesseract_cmd = r'C:\Program Files\Tesseract-OCR\tesseract.exe'  # Windows
# For Linux/macOS, Tesseract should be installed and accessible in PATH
...
def query_huggingface_api(prompt, model_name="mistralai/Mistral-Nemo-Instruct-2407", hf_token="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"):
